...
(
  ...
  BAL_GRP_OBJ_TYPE			VIRTUAL_CHAR TERMINATED BY X'20', -- ACCOUNT_POID
  ...
  PRODUCT_OBJ_TYPE			VIRTUAL_CHAR TERMINATED BY X'20', -- PIN_PRODUCT_POID
  ...
  OFFERING_OBJ_TYPE			VIRTUAL_CHAR TERMINATED BY X'20', -- PIN_OFFERING_POID
