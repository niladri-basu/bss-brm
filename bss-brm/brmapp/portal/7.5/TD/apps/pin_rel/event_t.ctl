...
(
  ...
  ACCOUNT_OBJ_TYPE                  VIRTUAL_CHAR TERMINATED BY X'20', -- ACCOUNT_POID
  ...
  SERVICE_OBJ_TYPE                  VIRTUAL_CHAR TERMINATED BY X'20', -- SERVICE_POID
  ...
  ITEM_OBJ_TYPE                     VIRTUAL_CHAR TERMINATED BY X'20', -- ITEM_POID
  ...
  RERATE_OBJ_TYPE                   VIRTUAL_CHAR TERMINATED BY X'20', -- ORIGINAL_EVENT_POID
  ...
  COMPACT_SUB_EVENT		    CHAR(4000), -- COMPACT_SUB_EVENT
  ...
  PROGRAM_NAME                      CONSTANT 'REL',
  CREATED_T                         CONSTANT 1044035814,
  MOD_T                             CONSTANT 1044035814,
  POID_DB                           CONSTANT 1,
  POID_TYPE                         VIRTUAL_CONSTANT '/event/delayed/session/gprs',
  SYS_DESCR                         CONSTANT '/event/delayed/session/gprs',
  SESSION_OBJ_DB                    CONSTANT 1,
  SESSION_OBJ_TYPE                  VIRTUAL_CONSTANT '/batch/rel',
  SESSION_OBJ_ID0                   CONSTANT 212566383975886336,
  SESSION_OBJ_REV                   CONSTANT 0,
  USERID_DB                         CONSTANT 1,
  USERID_TYPE                       VIRTUAL_CONSTANT '/service/pcm_client',
  USERID_ID0                        CONSTANT 1,
  USERID_REV                        CONSTANT 1
)
