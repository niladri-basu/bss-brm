       ...
       char *argv[])
{
	 ...
	 void            *vp = NULL;
         ...
         char           *ass_owner = "cAssociationDiscount";
         char           *dom = "DOM";
         char           *dom_val = "1";
	...
	/******************************
	  ...
	  dom_val = argv[1];	
          ...
          ***********************************************************
                ...
                2            PIN_FLD_LABEL           STR [0] "cAssociationDiscount"
...
td_get_active_owner(
        ...
        pin_errbuf_t    *ebufp)
 {
        ...
        int32           rec_id = 0;
        pin_cookie_t    cookie = 0;
        char          *ass_member = "cAssociationMemberDiscount";
        ...
        0 PIN_FLD_ARGS          ARRAY [3] allocated 20, used 1
        1        PIN_FLD_EXTRATING    SUBSTRUCT [0] allocated 20, used 1
        2            PIN_FLD_LABEL           STR [0] "cAssociationMemberDiscount"
