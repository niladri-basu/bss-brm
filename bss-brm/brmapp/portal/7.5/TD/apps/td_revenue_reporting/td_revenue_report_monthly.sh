...
bi.ACCOUNT_OBJ_ID0,
e.poid_id0 as epoid 
from  pin.event_t e, pin.event_bal_impacts_t eb,pin.billinfo_t bi,pin.account_nameinfo_t act,pin.account_t a--,pin.purchased_product_t ppt
where eb.resource_id=''1000116''
...
(select  
(td_unix_to_nz(e.start_t)) as start_t,bi.poid_id0 as BILLINFO_POID,bi.ACCOUNT_OBJ_ID0,e.poid_id0 as epoid
