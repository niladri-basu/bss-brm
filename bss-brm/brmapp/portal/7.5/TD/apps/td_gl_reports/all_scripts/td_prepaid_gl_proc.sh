...
outfile=`egrep -v "#" login.cfg | grep "OUTFILE_DIR" |cut -d'=' -f2 |sed -e 's/$/\/td_prepaid_gl_proc.log/'`
...
@./all_scripts/td_prepaid_gl_billed_proc.sql;
exec td_prepaid_gl_report_proc ($1,$2,$3);
