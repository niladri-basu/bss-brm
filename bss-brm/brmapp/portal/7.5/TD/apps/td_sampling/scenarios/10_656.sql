select distinct iot.billinfo_poid_id0 ||',10_656'
from purchased_product_t ppt, service_t st, product_t pt, bal_grp_t bgt, IOT_BILLINFO_T iot, IOT_PCFT_T pcft, billinfo_t bit
...
and pcft.CHARGED_TO_T between  bit.last_bill_t and bit.next_bill_t
and exists 
