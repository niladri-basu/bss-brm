select distinct iot.billinfo_poid_id0 ||',11_785'
...
and exists
(select 1 from event_billing_payment_t ebpt
where ebpt.channel_id in (21,24,30,33) 
and ebpt.trans_id=ebt.sub_trans_id)
and exists
(select 1
