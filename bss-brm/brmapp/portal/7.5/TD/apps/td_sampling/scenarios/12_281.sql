select distinct iot.billinfo_poid_id0 ||',12_281'
...
and ppt.status=1
and ppt.PRODUCT_OBJ_ID0 in ('2287946202','2287944666','320574462','84907996')
...
and pp.cycle_end_t < b.next_BILL_T
and pp.status=1);