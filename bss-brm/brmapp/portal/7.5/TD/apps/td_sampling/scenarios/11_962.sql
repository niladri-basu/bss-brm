select distinct iot.billinfo_poid_id0 ||',11_962'
from purchased_product_t ppt, service_t st, product_t pt, bal_grp_t bgt, IOT_BILLINFO_T iot, billinfo_t bt
...
and ppt.status=1
and pt.poid_id0=2287944762
and ppt.cycle_start_t < bt.next_BILL_T
