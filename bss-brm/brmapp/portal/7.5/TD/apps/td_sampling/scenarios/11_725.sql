select distinct iot.billinfo_poid_id0 ||',11_725'
...
and ppt.status=1
and pt.name='$70 Carryover Plan'
and months_between( unix_to_date(pcft.CHARGED_TO_T), unix_to_date(pcft.CHARGED_FROM_T))<>1;
