...
from TD_FS_BILLING_EXTRACT_T fb, bill_t bt , billinfo_t bi , account_t acc ,  EVENT_BILLING_PAYMENT_t ebp, EVENT_BILLING_PAYMENT_FS_T ebf , event_t et
where fb.INVOICE_NO = bt.BILL_NO
and bt.BILLINFO_OBJ_ID0 = bi.poid_id0
and acc.poid_id0 = bi.account_obj_id0
and acc.poid_id0 = et.account_obj_id0
and et.poid_id0 = ebp.obj_id0
and ebf.obj_id0 = ebp.obj_id0
