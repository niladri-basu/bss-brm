...
#outfile=`egrep -v "#" login.cfg | grep "OUTFILE_DIR" |cut -d'=' -f2 |sed -e 's/$/\/td_fs_billing_extract_dropcheck.log/'`
outfile=/brmapp/portal/7.5/TD/apps/td_farmsource_bill_control/fs_control_logs/td_fs_bill_control_dropcheck.log
#echo $outfile
#echo $LOGINSQL
