...
where
    ET.POID_ID0 >=(select TO_NUMBER(TO_CHAR((TO_DATE(TRUNC(sysdate)-1) - TO_DATE('1-Jan-1970') )*power(2,44)) + power(2,60)) from DUAL) 
and ET.POID_ID0 < (select TO_NUMBER(TO_CHAR((TO_DATE(TRUNC(sysdate)) - TO_DATE('1-Jan-1970') )*power(2,44)) + power(2,60)) from DUAL)
