...
# @(#)$Id: default_values_75ps4.pl /cgbubrm_7.5.0.rwsmod/3 2013/03/08 01:31:51 mkothari Exp $ 
#
# $Header: bus_platform_vob/upgrade/upgrade_75ps4/oracle/default_values_75ps4.pl /cgbubrm_7.5.0.rwsmod/3 2013/03/08 01:31:51 mkothari Exp $
#
# default_values_75ps4.pl
#
# Copyright (c) 2009, 2013, Oracle and/or its affiliates. All rights reserved. 
#
#    NAME
#      default_values_75ps4.pl -  This module will result in modyfying existing Business Params or
#                              doing Data Reorganization
#
#    DESCRIPTION
#      This File will contain subroutines to modifying existing Business Params or
#      doing Data Reorganization
#      This file will be called from pin_upgrade_75ps4.pl .
#
#    NOTES
#
#	This Script will be used to execute the script "default_values_75ps4.source"
#	The script "default_values_75ps4.source" will be containing the logic for
...
our @DEFAULT_VALUES_SCRIPTS_75PS4 = ("bus_param_billing_apply_ar_parent_cycle_fee_first_75ps4.source",
				     "bus_param_subscription_use_priority_subscription_fees_75ps4.source",
				     "bus_param_billing_split_sponsor_item.source",
				     "dd_type_index_75_virtual_col.source");

sub default_values_75ps4 {

	my $file = "";
	my $time_stamp = "";
	my $tmpOutFile          = "$PIN_TEMP_DIR" . "/tmp_default_values75ps4.log";
	my $defaultvaluespinlog = "$PIN_TEMP_DIR" . "/default_values_75ps4.log";
	my $CMD = "";
	my $Result = 0;
	my $FirstElem = $DEFAULT_VALUES_SCRIPTS_75PS4[0];
	my $writestatement = "";
	my $return_status = -1;
	...
	if ( $FirstElem eq "" ) {
		...
		foreach $file (@DEFAULT_VALUES_SCRIPTS_75PS4) {
	...
	if ( $Result == 0 ) {
	        ...
	        open( TMPFILE3, ">>$defaultvaluespinlog " ) || die "cannot read $defaultvaluespinlog \n";
                $writestatement = "Successfull Execution of the function default_values_75ps4 \n";
                print TMPFILE3 ("$writestatement \n");
                close(TMPFILE3);
	} elsif ( $Result == 2 ) {
                print "File default_values_75ps4.source file is not found under $PIN_HOME/sys/dd/data directory. \n";
	} elsif ( $Result == 3 ) {
