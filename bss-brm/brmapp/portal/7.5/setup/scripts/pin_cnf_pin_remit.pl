#=======================================================================
#  @(#)%Portal Version: pin_cnf_pin_remit.pl:InstallVelocityInt:4:2005-Mar-25 18:11:34 %
# 
...
#
#========================================================================
$PIN_REMIT_PINCONF_HEADER  =  <<END
#======================================================================
# Configuration File for the Remittance Calculation Utility
#======================================================================
#
#======================================================================
# Use this file to specify how the remittance calculation utility
...
%PIN_REMIT_PINCONF_ENTRIES = (
	"pin_remit_logfile_description", <<END
#======================================================================
# pin_remit_logfile
#
...
END
	,"pin_remit_logfile"
	,"- pin_remit logfile \$\{PIN_LOG_DIR\}/pin_remit/pin_remittance.pinlog"

	,"pin_remit_loglevel_description", <<END
#======================================================================
# pin_remit_loglevel
#
