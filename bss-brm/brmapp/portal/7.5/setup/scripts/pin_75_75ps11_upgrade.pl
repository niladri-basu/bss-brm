...
#
# @(#)$Id: pin_75_75ps11_upgrade.pl /cgbubrm_7.5.0.rwsmod/4 2014/12/14 13:00:08 mkothari Exp $
#
# $Header: bus_platform_vob/upgrade/upgrade_75ps11/oracle/pin_75_75ps11_upgrade.pl /cgbubrm_7.5.0.rwsmod/4 2014/12/14 13:00:08 mkothari Exp $
#
# pin_75ps11_upgrade.pl
# 
# Copyright (c) 2009, 2014, Oracle and/or its affiliates. All rights reserved.
#
#    NAME
#      pin_75_75ps11_upgrade.pl - this script is the main driver file
...
#
#       e.g. In the Driver file "pin_75_75ps11_upgrade.pl" there will be a subroutine like
...
require "add_new_objects_75ps11.pl";
require "default_values_75ps11.pl";
...
our $upgrade75pinlog = "$PIN_TEMP_DIR" . "/" . "upgrade_75ps11.log";
our $msgstring = "";
our $return_status  = 0;
our $writestatement = "";
...
our @EXECUTE_ALL_UPGRADE_SCRIPTS = (
	"create_new_objects_75ps11()",
	"modify_existing_objects_75ps11()",
	"default_values_75ps11()",
        );
...
if ( $ret_val == 0 || $ret_val == -1) {
	...
	if (VerifyPresenceOfTable($collection_opt_mgr_table, %{ $DM{"db"} }) == 0) {
        ...
        print "PortalBase Schema upgrade to BRM 75ps11 is successful. \n";
        open(UPGRADE_PINLOG_FILE_HANDLER, ">>$upgrade75pinlog " ) || die "cannot open $upgrade75pinlog for writing. \n";
        $msgstring ="PortalBase Schema upgrade to BRM 75ps11 is successful. \n";
...
sub upgrade_75 {
        ...
        my $api_result = -1;
        my $Result = 0;
        my $upgrade75pinlog = "$PIN_TEMP_DIR" . "/" . "upgrade_75ps11.log";
        my $writestatement = "";
	...
	# cleaning up the upgrade log file before executing upgrade scripts.
        ...
        if ( $firstelem eq "" ) {
                ...
                foreach $upgrade_api (@EXECUTE_ALL_UPGRADE_SCRIPTS) {
                                print "################################################ \n";
                                print "Upgrade BRM 75ps11 is now executing $upgrade_api \n";
