...
# @(#)$Id: default_values_75ps3.pl /cgbubrm_7.5.0.rwsmod/3 2014/08/27 06:54:42 mkothari Exp $ 
#
# $Header: bus_platform_vob/upgrade/upgrade_75ps3/oracle/default_values_75ps3.pl /cgbubrm_7.5.0.rwsmod/3 2014/08/27 06:54:42 mkothari Exp $
#
# default_values_75ps3.pl
#
# Copyright (c) 2009, 2014, Oracle and/or its affiliates. All rights reserved.
#
#    NAME
#      default_values_75ps3.pl -  This module will result in modyfying existing Business Params or
#                              doing Data Reorganization
#
#    DESCRIPTION
#      This File will contain subroutines to modifying existing Business Params or
#      doing Data Reorganization
#      This file will be called from pin_upgrade_75ps3.pl .
#
#    NOTES
#
#	This Script will be used to execute the script "default_values_75ps3.source"
#	The script "default_values_75ps3.source" will be containing the logic for
...
our @DEFAULT_VALUES_SCRIPTS_75ps3 = ("pipeline_startup_validity_update_ps3.source",
				     "pin_amt_schema_upgrade_ps3.source",
				     "create_indexes_offer_profile_upgrade.source");

sub default_values_75ps3 {

	my $file = "";
	my $time_stamp = "";
	my $tmpOutFile          = "$PIN_TEMP_DIR" . "/tmp_default_values75ps3.log";
	my $defaultvaluespinlog = "$PIN_TEMP_DIR" . "/default_values_75ps3.log";
	my $CMD = "";
	my $Result = 0;
	my $FirstElem = $DEFAULT_VALUES_SCRIPTS_75ps3[0];
	my $writestatement = "";
	my $return_status = -1;
	...
	if ( $FirstElem eq "" ) {
		...
		foreach $file (@DEFAULT_VALUES_SCRIPTS_75ps3) {
	...
	if ( $Result == 0 ) {
	        ...
	        open( TMPFILE3, ">>$defaultvaluespinlog " ) || die "cannot read $defaultvaluespinlog \n";
                $writestatement = "Successfull Execution of the function default_values_75ps3 \n";
                print TMPFILE3 ("$writestatement \n");
                close(TMPFILE3);
	} elsif ( $Result == 2 ) {
                print "File default_values_75ps3.source file is not found under $PIN_HOME/sys/dd/data directory. \n";
	} elsif ( $Result == 3 ) {
