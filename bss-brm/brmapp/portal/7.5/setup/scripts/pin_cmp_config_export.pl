...
#@(#)%Portal Version: pin_cmp_config_export.pl:PortalBase7.3.1Int:1:2007-Sep-24 21:16:34 %
#=============================================================
# 
#
...
#--
#
# Infranet installation for the config export component
#
#=============================================================
...
#
##########################################
sub configure_config_export_config_files {
  local ( %DM ) = %MAIN_DM;
  local ( %CM ) = %MAIN_CM;
  local( $Cmd );
  local ( $TEMP ) = $CurrentComponent;
  
  &ReadIn_PinCnf( "pin_cnf_config_export.pl" );
  ...
  {
    &ReplacePinConfEntries( $CM{'location'}."/".$PINCONF, %CONFIG_EXPORT_PINCONF_ENTRIES );
  ...
  else
  {
    ...
    &ReplacePinConfEntries( "$TEMP_PIN_CONF_FILE", %CONFIG_EXPORT_PINCONF_ENTRIES );
...
#
#####################################
sub configure_config_export_database {
