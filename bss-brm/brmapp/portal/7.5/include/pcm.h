/*
 * @(#)$Id: pcm.h /cgbubrm_7.5.0.rwsmod/9 2014/11/17 21:33:27 vinodrao Exp $
 *
...
#define PCM_OPFLG_LOCK_NONE             0x200000
...
#define PIN_ERR_IS_ERR(ebufp)						\
	((ebufp)?((ebufp)->pin_err != PIN_ERR_NONE):fprintf(stderr, "\n*** Error buffer not initialized ***\n"))
