/* @(#)$Id: pin_bill.h /cgbubrm_7.5.0.rwsmod/19 2014/12/12 09:59:09 kpramod Exp $ */
/*
 *
...
static char *map_seq_id_to_name[] = {
	...
	(char *)"PIN_SEQUENCE_TYPE_MANDATE_ID",   /* 12 */
	(char *)"PIN_SEQUENCE_TYPE_SDD_MSG_ID",   /* 13 */
	(char *)"PIN_SEQUENCE_TYPE_SCT_MSG_ID",   /* 14 */
	(char *)"PIN_SEQUENCE_TYPE_REV_MSG_ID",   /* 15 */
	(char *)"PIN_SEQUENCE_TYPE_PYMTINFO_ID",  /* 16 */
	(char *)NULL
};
