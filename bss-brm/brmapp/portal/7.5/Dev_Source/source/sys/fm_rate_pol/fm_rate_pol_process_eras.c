...
#ifndef lint
static const char Sccs_id[] = "@(#)$Id: fm_rate_pol_process_eras.c /cgbubrm_7.5.0.idcmod/4 2014/03/14 11:06:33 bmaturi Exp $";
#endif
...
#define FILE_SOURCE_ID  "fm_rate_pol_process_eras.c(20)"
