...
#ifndef lint
static  char Sccs_Id[] = "@(#)$Id: fm_cust_pol_get_intro_msg.c /cgbubrm_7.5.0.rwsmod/1 2013/09/12 11:29:28 amandavi Exp $";
#endif
	...
	pin_errbuf_t	*ebufp)
{
	...
	memset(macro, 0, CM_FM_MAX_CONFIG_FILE_LINE_LEN+1);
