/* file information --- @(#)$Id: pin_pymt.h /cgbubrm_7.5.0.rwsmod/10 2014/12/17 23:02:12 praghura Exp $ */
/*
 *
...
typedef enum pin_token_card_type {
	PIN_TOKEN_NONE = 		0,       /* This is used to specify that this a credit card number and not token */
        ...
        PIN_TOKEN_JCB =         	8,
        PIN_TOKEN_SWITCH =      	9,
	PIN_TOKEN_UNKNOWN = 		10       /* This is used when we know that it is a token, but we do not know the card type */
...
typedef enum pin_pay_type {
	...
	PIN_PAY_TYPE_FARMSOURCE  = 10101	/* Partner farmsource */
} pin_pay_type_t;
