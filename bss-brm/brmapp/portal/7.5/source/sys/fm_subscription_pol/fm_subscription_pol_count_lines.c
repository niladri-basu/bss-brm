...
#ifndef lint
static  char      Sccs_id[] = "@(#)$Id: fm_subscription_pol_count_lines.c /cgbubrm_7.3.2.rwsmod/1 2009/03/24 07:02:22 amamidi Exp $";
#endif

/*******************************************************************
 * Contains the PCM_OP_SUBSCRIPTION_POL_COUNT_LINES operation. 
 *******************************************************************/
...
#define FILE_SOURCE_ID  "fm_subscription_pol_count_lines.c(1)"
