...
#ifndef lint
static char Sccs_id[] = "@(#)$Id: fm_pymt_pol_validate_payment.c /cgbubrm_7.5.0.rwsmod/3 2014/09/15 09:54:49 rpradyum Exp $";
#endif
	...
	pin_errbuf_t            *ebufp)
{
	...
	if (psiu_bparams_get_str(ctxp, PSIU_BPARAMS_AR_PARAMS,
		...
		strcpy(template, " select X from /item 1, /event 2 where "
			"event_poid_list is null and 1.F1 = V1 "
			"and 1.F2 like V2 and 2.F3 like V3 and 1.F4 = 2.F5 ");
		...
		/********************************************************
                ...
                if (!res_flistp) {
                        ...
                        if (!bparam_reject_prev_bill) {
                                ...
                                strcpy(template, "select X from /history_bills where F1 = V1 and ar_billinfo_obj_id0 = billinfo_obj_id0 ");
