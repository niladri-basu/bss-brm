/* continuus file information --- %full_filespec: fm_cust_pol_encrypt_pwdmd5.c~5:csrc:1 % */
/*******************************************************************
 *
 ...
 *
 * Any and all portions not Copyright RSA are Copyright Oracle.
 *
 *******************************************************************/
 ...
 * make_digest():
 *
 *	Produces an MD5 digest of a string.
 *	Digest must be at least 16 byte long.
 *
 *	Added by richw@mks.com.
 *
 *******************************************************************/
void
make_digest(string, digest)
char	*string;
