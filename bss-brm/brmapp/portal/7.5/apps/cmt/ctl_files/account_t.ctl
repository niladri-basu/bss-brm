...
APPEND
  ...
  (
	...
	ACCESS_CODE1 		CHAR TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"' "nvl(:ACCESS_CODE1,'')",
        ACCESS_CODE2            CHAR TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"' "nvl(:ACCESS_CODE2,'')",
	LOCALE                  CHAR TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"' "nvl(:LOCALE,'')",
