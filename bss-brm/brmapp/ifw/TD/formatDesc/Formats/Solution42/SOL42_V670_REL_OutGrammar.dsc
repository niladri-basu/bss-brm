  ...
  details: 
      ...
      DETAIL
	    ...
	    //------------------------------------------------------------------
            // Added by GSM
            //------------------------------------------------------------------
          edrNumDatablocks( DETAIL.ASS_CI ) +  
           //------------------------------------------------------------------
	  ...
	  //--------------------------------------------------------------------
		...
		//tax packets
          ...
          {
            recordNumber = recordNumber + 1;
            edrOutputMap( "SOL42_V670_REL.ASS_CI_MAPPING.STD_MAPPING", 0 );
          }

          for ( i = 0; i < edrNumDatablocks( DETAIL.ASS_CI.ASS_BRI, 0 ); i = i + 1 )
          {
            recordNumber = recordNumber + 1;
            edrOutputMap( "SOL42_V670_REL.ASS_BRI_MAPPING.STD_MAPPING", 0 , i);
          }
          ...
          {
           recordNumber = recordNumber + 1;
           edrOutputMap( "SOL42_V670_REL.ASS_TEL_MAPPING.STD_MAPPING", 0 , 0);
          }

          if ( edrNumDatablocks( DETAIL.ASS_CI.ASS_SMS, 0) > 0 )
          {
           recordNumber = recordNumber + 1;
           edrOutputMap( "SOL42_V670_REL.ASS_SMS_MAPPING.STD_MAPPING", 0 , 0);
          }

          if ( edrNumDatablocks( DETAIL.ASS_CI.ASS_DAT, 0) > 0 )
          {
           recordNumber = recordNumber + 1;
           edrOutputMap( "SOL42_V670_REL.ASS_DAT_MAPPING.STD_MAPPING", 0 , 0);
          }

          if ( edrNumDatablocks( DETAIL.ASS_CI.ASS_VV, 0) > 0 )
          {
           recordNumber = recordNumber + 1;
           edrOutputMap( "SOL42_V670_REL.ASS_VV_MAPPING.STD_MAPPING", 0 , 0);
          }

          if ( edrNumDatablocks( DETAIL.ASS_CI.ASS_VOM, 0) > 0 )
          {
           recordNumber = recordNumber + 1;
           edrOutputMap( "SOL42_V670_REL.ASS_VOM_MAPPING.STD_MAPPING", 0 , 0);
          }

          if ( edrNumDatablocks( DETAIL.ASS_CI.ASS_MMS, 0) > 0 )
          {
           recordNumber = recordNumber + 1;
           edrOutputMap( "SOL42_V670_REL.ASS_MMS_MAPPING.STD_MAPPING", 0 , 0);
          }

          if ( edrNumDatablocks( DETAIL.ASS_CI.ASS_VAS, 0) > 0 )
          {
           recordNumber = recordNumber + 1;
           edrOutputMap( "SOL42_V670_REL.ASS_VAS_MAPPING.STD_MAPPING", 0 , 0);
          }
