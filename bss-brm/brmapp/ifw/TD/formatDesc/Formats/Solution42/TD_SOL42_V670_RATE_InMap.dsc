...
//------------------------------------------------------------------------------
// Module Description:
//   Input mapping for the Solution42 V6.70 REL CDR format with Unix timestamps
//
// Open Points:
//   <open points>
//
...
//
// $RCSfile: SOL42_V670_REL_InMap.dsc $
// $Revision: /cgbubrm_7.5.0.pipeline/1 $
// $Author: sknanda $
// $Date: 2012/08/30 23:26:40 $
// $Locker:  $
//------------------------------------------------------------------------------
// $Log: SOL42_V670_REL_InMap.dsc,v $
//==============================================================================
...
SOL42_FORINPUT
{
  ...
  ASSOCIATED_LTE
  {
    STD_MAPPING
    {
      RECORD_TYPE                       -> DETAIL.ASS_LTE_EXT.RECORD_TYPE;
  ...
  RUM_MAP
  {
    STD_MAPPING
    {
      RECORD_TYPE                      -> DETAIL.ASS_CBD.RM.RECORD_TYPE;
  ...
  TAX_PACKET
  {
    STD_MAPPING
    {
      RECORD_TYPE                       -> DETAIL.ASS_CBD.TP.RECORD_TYPE;
  ...
  SUB_BAL_IMPACT
  {
    STD_MAPPING
    {
      RECORD_TYPE                 -> DETAIL.ASS_PIN.SBI.RECORD_TYPE;
  ...
  SUB_BAL
  {
    STD_MAPPING
    {
      RECORD_TYPE                 -> DETAIL.ASS_PIN.SBI.SB.RECORD_TYPE;
  ...
  MONITOR_PACKET
  {
    STD_MAPPING
    {
      RECORD_TYPE               -> DETAIL.ASS_PIN.MP.RECORD_TYPE;
  ...
  MONITOR_SUB_BAL_IMPACT
  {
    STD_MAPPING
    {
      RECORD_TYPE                 -> DETAIL.ASS_PIN.MSBI.RECORD_TYPE;
  ...
  MONITOR_SUB_BAL
  {
    STD_MAPPING
    {
      RECORD_TYPE                 -> DETAIL.ASS_PIN.MSBI.MSB.RECORD_TYPE;
  ...
  ASSOCIATED_SUSPENSE
  {
    STD_MAPPING
    {
      RECORD_TYPE               -> DETAIL.ASS_SUSPENSE_EXT.RECORD_TYPE;
  ...
  ASSOCIATED_ROAMING
  {
    STD_MAPPING
    {
      RECORD_TYPE               -> DETAIL.ASS_ROAMING_EXT.RECORD_TYPE;
  ...
  ASSOCIATED_CIBER
  {
    STD_MAPPING
    {
      RECORD_TYPE                           -> DETAIL.ASS_CIBER_EXT.RECORD_TYPE;
...
ASS_CI_MAPPING
{
  STD_MAPPING
    {
       		RECORD_TYPE                       	-> DETAIL.ASS_CI.RECORD_TYPE;
    ...
    ASS_BRI_MAPPING
    {
       STD_MAPPING
      {
         RECORD_TYPE                       -> DETAIL.ASS_CI.ASS_BRI.RECORD_TYPE;
    ...
    ASS_TEL_MAPPING
    {
       STD_MAPPING
	{
		RECORD_TYPE   -> DETAIL.ASS_CI.ASS_TEL.RECORD_TYPE;
    ...
    ASS_SMS_MAPPING
    {
       STD_MAPPING
	{
	   RECORD_TYPE   		-> DETAIL.ASS_CI.ASS_SMS.RECORD_TYPE;
    ...
    ASS_DAT_MAPPING
    {
       STD_MAPPING
	{
	 RECORD_TYPE   				-> DETAIL.ASS_CI.ASS_DAT.RECORD_TYPE;
    ...
    ASS_VV_MAPPING
    {
       STD_MAPPING
	{
	   RECORD_TYPE   				-> DETAIL.ASS_CI.ASS_VV.RECORD_TYPE;
    ...
    ASS_VOM_MAPPING
    {
       STD_MAPPING
	{
		RECORD_TYPE   -> DETAIL.ASS_CI.ASS_VOM.RECORD_TYPE;
    ...
    ASS_MMS_MAPPING
    {
       STD_MAPPING
	{
	   RECORD_TYPE   		-> DETAIL.ASS_CI.ASS_MMS.RECORD_TYPE;
    ...
    ASS_VAS_MAPPING
    {
       STD_MAPPING
	{
	   RECORD_TYPE   				-> DETAIL.ASS_CI.ASS_VAS.RECORD_TYPE;
