...
//--------------------------------------------------------------------
  INV_CUST_INFO
  {
    ...
    PACKAGE_GROUP_TEST
    {
       STD_MAPPING
      {
      	PACK_GROUP_DISPLAY		<- DETAIL.PK_GROUP_DISPLAY;
      	ORIGINATING_COUNTRY		<- DETAIL.ORIGINATING_COUNTRY;
