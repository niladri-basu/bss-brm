...
#	
#########################################################################################
# Utility script for PipeLine ---> Start All Pipelines.
#########################################################################################
...
sub start_recycle {
  ...
  open(INSTRM, "$ENV{'IFW_HOME_PATH'}/semaphore/start_recycle.reg") || die "Cannot open file :$!";
  ...
  print "Semaphore for start_recycle is sent \n";
}
