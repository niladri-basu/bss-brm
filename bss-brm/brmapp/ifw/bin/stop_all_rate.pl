...
#	
#########################################################################################
# Utility script for PipeLine ---> Stop ALL_RATE Pipeline
#########################################################################################
...
sub stop_all_rate {
  ...
  open(INSTRM, "$ENV{'IFW_HOME_PATH'}/semaphore/stop_all_rate.reg") || die "Cannot open file :$!";
  ...
  print "Semaphore for stop_all_rate is sent \n";
}
