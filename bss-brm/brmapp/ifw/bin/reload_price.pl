...
#	
#########################################################################################
# Utility script for PipeLine ---> Reload THE Price Model
#########################################################################################
...
sub reload_price {
  ...
  open(INSTRM, "$ENV{'IFW_HOME_PATH'}/semaphore/reload_price.reg") || die "Cannot open file :$!";
  ...
  print "Semaphore for reload_price is sent \n";
}
