...
#	
#########################################################################################
# Utility script for PipeLine ---> Start ALL_RATE Pipeline
#########################################################################################
...
sub start_all_rate {
  ...
  open(INSTRM, "$ENV{'IFW_HOME_PATH'}/semaphore/start_all_rate.reg") || die "Cannot open file :$!";
  ...
  print "Semaphore for start_all_rate is sent \n";
}
