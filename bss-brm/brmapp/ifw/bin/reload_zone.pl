...
#	
#########################################################################################
# Utility script for PipeLine ---> Reload THE Zone Model
#########################################################################################
...
sub reload_zone {
  ...
  open(INSTRM, "$ENV{'IFW_HOME_PATH'}/semaphore/reload_zone.reg") || die "Cannot open file :$!";
  ...
  print "Semaphore for reload_zone is sent \n";
}
