...
//------------------------------------------------------------------------------
// Module Description:
//   Generic I/O input grammar file for the Solution42 V6.30 CDR format
//
// Open Points:
//   <open points>
//
...
Grammar
{
      ...
      SOL42_V650.HEADER 
        {
          ...
          edrInputMap( "SOL42_V650.HEADER.STD_MAPPING" );
      ...
      SOL42_V650.TRAILER 
        {
          ...
          edrInputMap( "SOL42_V650.TRAILER.STD_MAPPING" );
      ...
      SOL42_V650.DETAIL
        {
          ...
          edrInputMap( "SOL42_V650.DETAIL.STD_MAPPING" );
  ...
  //----------------------------------------------------------------------------
  associated_charge:
      SOL42_V650.ASSOCIATED_CHARGE 
        {
          edrAddDatablock( DETAIL.ASS_CBD );
          edrInputMap( "SOL42_V650.ASSOCIATED_CHARGE.STD_MAPPING" );
        }
      charge_packet_list
  ...
  charge_packet_list:
      charge_packet_list
      SOL42_V650.CHARGE_PACKET 
        {
          edrAddDatablock( DETAIL.ASS_CBD.CP );
          edrInputMap( "SOL42_V650.CHARGE_PACKET.STD_MAPPING" );
        }
    | /* EMPTY */
    ;
  ...
  discount_packet_list:
      discount_packet_list
      SOL42_V650.DISCOUNT_PACKET 
        {
          edrAddDatablock( DETAIL.ASS_CBD.DP );
          edrInputMap( "SOL42_V650.DISCOUNT_PACKET.STD_MAPPING" );
        }
      subbal_packet_list
    | /* EMPTY */
    ;
  ...
  subbal_packet_list:
      subbal_packet_list
      SOL42_V650.DISCOUNT_SUBBALANCE 
        {
          edrAddDatablock( DETAIL.ASS_CBD.DP.SUB_BALANCE );
          edrInputMap( "SOL42_V650.DISCOUNT_SUBBALANCE.STD_MAPPING" );
        }
    | /* EMPTY */
    ;
  ...
  //----------------------------------------------------------------------------
  associated_zone:
      SOL42_V650.ASSOCIATED_ZONE 
        {
          edrAddDatablock( DETAIL.ASS_ZBD );
          edrInputMap( "SOL42_V650.ASSOCIATED_ZONE.STD_MAPPING" );
        }
      zone_packet_list
    ;
  ...
  zone_packet_list:
      zone_packet_list
      SOL42_V650.ZONE_PACKET 
        {
          edrAddDatablock( DETAIL.ASS_ZBD.ZP );
          edrInputMap( "SOL42_V650.ZONE_PACKET.STD_MAPPING" );
        }
    | /* EMPTY */
    ;
  ...
  //----------------------------------------------------------------------------
  associated_gsmw:
      SOL42_V650.ASSOCIATED_GSMW 
        {
          edrAddDatablock( DETAIL.ASS_GSMW_EXT );
          edrInputMap( "SOL42_V650.ASSOCIATED_GSMW.STD_MAPPING" );
        }
  ...
  ss_event_packet_list:
      ss_event_packet_list
      SOL42_V650.SS_EVENT_PACKET
        {
          edrAddDatablock( DETAIL.ASS_GSMW_EXT.SS_PACKET );
          edrInputMap( "SOL42_V650.SS_EVENT_PACKET.STD_MAPPING" );
        }
    | /* EMPTY */
    ;
  ...
  //----------------------------------------------------------------------------
  associated_infranet:
      SOL42_V650.ASSOCIATED_INFRANET 
        {
          edrAddDatablock( DETAIL.ASS_PIN );
          edrInputMap( "SOL42_V650.ASSOCIATED_INFRANET.STD_MAPPING" );
        }
      balance_packet_list
    ;
  ...
  balance_packet_list:
      balance_packet_list
      SOL42_V650.BALANCE_PACKET 
        {
          edrAddDatablock( DETAIL.ASS_PIN.BP );
          edrInputMap( "SOL42_V650.BALANCE_PACKET.STD_MAPPING" );
        }
    | /* EMPTY */
    ;
  ...
  //----------------------------------------------------------------------------
  associated_gprs:
      SOL42_V650.ASSOCIATED_GPRS 
        {
          edrAddDatablock( DETAIL.ASS_GPRS_EXT );
          edrInputMap( "SOL42_V650.ASSOCIATED_GPRS.STD_MAPPING" );
        }
    ;
  ...
  //----------------------------------------------------------------------------
  associated_wap:
      SOL42_V650.ASSOCIATED_WAP 
        {
          edrAddDatablock( DETAIL.ASS_WAP_EXT );
          edrInputMap( "SOL42_V650.ASSOCIATED_WAP.STD_MAPPING" );
        }
    ;
  ...
  //----------------------------------------------------------------------------
  associated_camel:
      SOL42_V650.ASSOCIATED_CAMEL 
        {
          edrAddDatablock( DETAIL.ASS_CAMEL_EXT );
          edrInputMap( "SOL42_V650.ASSOCIATED_CAMEL.STD_MAPPING" );
        }
    ;
  ...
  //----------------------------------------------------------------------------
  associated_message:
      SOL42_V650.ASSOCIATED_MESSAGE 
        {
          edrAddDatablock( DETAIL.ASS_MSG_DES );
          edrInputMap( "SOL42_V650.ASSOCIATED_MESSAGE.STD_MAPPING" );
        }
    ;
