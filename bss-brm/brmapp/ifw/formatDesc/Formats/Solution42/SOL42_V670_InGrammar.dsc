...
//------------------------------------------------------------------------------
// Module Description:
//   Generic I/O input grammar file for the Solution42 V6.70 CDR format 
...
//
// $RCSfile: SOL42_V670_InGrammar.dsc $
// $Revision: /cgbubrm_7.3.2.pipeline/1 $
// $Author: knijhawa $
// $Date: 2009/02/08 21:45:19 $
// $Locker:  $
//------------------------------------------------------------------------------
// $Log: SOL42_V670_InGrammar.dsc,v $
//==============================================================================
...
Grammar
{
      ...
      SOL42_V670.HEADER 
        {
          ...
          edrInputMap( "SOL42_V670.HEADER.STD_MAPPING" );
      ...
      SOL42_V670.TRAILER 
        {
          ...
          edrInputMap( "SOL42_V670.TRAILER.STD_MAPPING" );
      ...
      SOL42_V670.DETAIL
        {
          ...
          edrInputMap( "SOL42_V670.DETAIL.STD_MAPPING" );
  ...
  //----------------------------------------------------------------------------
  associated_charge:
      SOL42_V670.ASSOCIATED_CHARGE 
        {
          edrAddDatablock( DETAIL.ASS_CBD );
          edrInputMap( "SOL42_V670.ASSOCIATED_CHARGE.STD_MAPPING" );
        }
      charge_packet_list
  ...
  charge_packet_list:
      charge_packet_list
      SOL42_V670.CHARGE_PACKET 
        {
          edrAddDatablock( DETAIL.ASS_CBD.CP );
          edrInputMap( "SOL42_V670.CHARGE_PACKET.STD_MAPPING" );
        }
    | /* EMPTY */
    ;
  ...
  discount_packet_list:
      discount_packet_list
      SOL42_V670.DISCOUNT_PACKET 
        {
          edrAddDatablock( DETAIL.ASS_CBD.DP );
          edrInputMap( "SOL42_V670.DISCOUNT_PACKET.STD_MAPPING" );
        }
      subbal_packet_list
    | /* EMPTY */
    ;
  ...
  subbal_packet_list:
      subbal_packet_list
      SOL42_V670.DISCOUNT_SUBBALANCE 
        {
          edrAddDatablock( DETAIL.ASS_CBD.DP.SUB_BALANCE );
          edrInputMap( "SOL42_V670.DISCOUNT_SUBBALANCE.STD_MAPPING" );
        }
    | /* EMPTY */
    ;
  ...
  //----------------------------------------------------------------------------
  associated_zone:
      SOL42_V670.ASSOCIATED_ZONE 
        {
          edrAddDatablock( DETAIL.ASS_ZBD );
          edrInputMap( "SOL42_V670.ASSOCIATED_ZONE.STD_MAPPING" );
        }
      zone_packet_list
    ;
  ...
  zone_packet_list:
      zone_packet_list
      SOL42_V670.ZONE_PACKET 
        {
          edrAddDatablock( DETAIL.ASS_ZBD.ZP );
          edrInputMap( "SOL42_V670.ZONE_PACKET.STD_MAPPING" );
        }
    | /* EMPTY */
    ;
  ...
  //----------------------------------------------------------------------------
  associated_gsmw:
      SOL42_V670.ASSOCIATED_GSMW 
        {
          edrAddDatablock( DETAIL.ASS_GSMW_EXT );
          edrInputMap( "SOL42_V670.ASSOCIATED_GSMW.STD_MAPPING" );
        }
  ...
  ss_event_packet_list:
      ss_event_packet_list
      SOL42_V670.SS_EVENT_PACKET
        {
          edrAddDatablock( DETAIL.ASS_GSMW_EXT.SS_PACKET );
          edrInputMap( "SOL42_V670.SS_EVENT_PACKET.STD_MAPPING" );
        }
    | /* EMPTY */
    ;
  ...
  //----------------------------------------------------------------------------
  associated_infranet:
      SOL42_V670.ASSOCIATED_INFRANET 
        {
          edrAddDatablock( DETAIL.ASS_PIN );
          edrInputMap( "SOL42_V670.ASSOCIATED_INFRANET.STD_MAPPING" );
        }
      balance_packet_list
    ;
  ...
  balance_packet_list:
      balance_packet_list
      SOL42_V670.BALANCE_PACKET
        {
          edrAddDatablock( DETAIL.ASS_PIN.BP );
          edrInputMap( "SOL42_V670.BALANCE_PACKET.STD_MAPPING" );
        }
    | /* EMPTY */
    ;
  ...
  //----------------------------------------------------------------------------
  associated_gprs:
      SOL42_V670.ASSOCIATED_GPRS 
        {
          edrAddDatablock( DETAIL.ASS_GPRS_EXT );
          edrInputMap( "SOL42_V670.ASSOCIATED_GPRS.STD_MAPPING" );
        }
    ;
  ...
  //----------------------------------------------------------------------------
  associated_wap:
      SOL42_V670.ASSOCIATED_WAP 
        {
          edrAddDatablock( DETAIL.ASS_WAP_EXT );
          edrInputMap( "SOL42_V670.ASSOCIATED_WAP.STD_MAPPING" );
        }
    ;
  ...
  //----------------------------------------------------------------------------
  associated_camel:
      SOL42_V670.ASSOCIATED_CAMEL 
        {
          edrAddDatablock( DETAIL.ASS_CAMEL_EXT );
          edrInputMap( "SOL42_V670.ASSOCIATED_CAMEL.STD_MAPPING" );
        }
    ;
  ...
  //----------------------------------------------------------------------------
  associated_message:
      SOL42_V670.ASSOCIATED_MESSAGE 
        {
          edrAddDatablock( DETAIL.ASS_MSG_DES );
          edrInputMap( "SOL42_V670.ASSOCIATED_MESSAGE.STD_MAPPING" );
        }
    ;
  ...
  //----------------------------------------------------------------------------
  associated_sms:
      SOL42_V670.ASSOCIATED_SMS
        {
          edrAddDatablock( DETAIL.ASS_SMS_EXT );
          edrInputMap( "SOL42_V670.ASSOCIATED_SMS.STD_MAPPING" );
        }
    ;
  ...
  //----------------------------------------------------------------------------
  associated_mms:
      SOL42_V670.ASSOCIATED_MMS
        {
          edrAddDatablock( DETAIL.ASS_MMS_EXT );
          edrInputMap( "SOL42_V670.ASSOCIATED_MMS.STD_MAPPING" );
        }
    ;
  ...
  //----------------------------------------------------------------------------
  associated_suspense:
      SOL42_V670.ASSOCIATED_SUSPENSE
        {
          edrAddDatablock( DETAIL.ASS_SUSPENSE_EXT );
          edrInputMap( "SOL42_V670.ASSOCIATED_SUSPENSE.STD_MAPPING" );
        }
    ;
  ...
  //----------------------------------------------------------------------------
  associated_ciber:
      SOL42_V670.ASSOCIATED_CIBER
        {
          edrAddDatablock( DETAIL.ASS_CIBER_EXT );
          edrInputMap( "SOL42_V670.ASSOCIATED_CIBER.STD_MAPPING" );
        }
    ;
  ...
  //----------------------------------------------------------------------------
  associated_roaming:
      SOL42_V670.ASSOCIATED_ROAMING
        {
          edrAddDatablock( DETAIL.ASS_ROAMING_EXT );
          edrInputMap( "SOL42_V670.ASSOCIATED_ROAMING.STD_MAPPING" );
        }
    ;
