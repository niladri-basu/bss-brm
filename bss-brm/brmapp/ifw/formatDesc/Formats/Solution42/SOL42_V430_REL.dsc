...
//------------------------------------------------------------------------------
// Module Description:
//   Description of the Sol42 V4-30-13 REL CDR format with Unix timestamps.
//
// Open Points:
//   <open points>
//
...
// Responsible: sd
//
// $RCSfile: SOL42_V430_REL.dsc,v $
// $Revision: 1.3 $
// $Author: pengelbr $
// $Date: 2001/10/01 06:54:55 $
// $Locker:  $
//------------------------------------------------------------------------------
// $Log: SOL42_V430_REL.dsc,v $
...
SOL42_V430_REL
{
  ...
  ASSOCIATED_GSMW(SEPARATED)
  {
    ...
    {
      Pattern = "520(\t[^\t\n]*){20}";
      SuccState = SOL42_V430_REL_SS_EVENT_PACKET;
      FieldSeparator = '\t';
    }
  ...
  SS_EVENT_PACKET(SEPARATED)
  {
    ...
    {
      Pattern = "([^\t\n]*\t){2}[^\t\n]*";
      States = (SOL42_V430_REL_SS_EVENT_PACKET);
      FieldSeparator = '\t';
    }
  ...
  ASSOCIATED_INFRANET(SEPARATED)
  {
    Info
    {
      Pattern = "900(\t[^\t\n]*){9}";
      FieldSeparator = '\t';
      SuccState = SOL42_V430_REL_BALANCE_PACKET;
    }
  ...
  BALANCE_PACKET(SEPARATED)
  {
    Info
    {
      Pattern = "([^\t\n]*\t){11}[^\t\n]*";
      FieldSeparator = '\t';
      States = (SOL42_V430_REL_BALANCE_PACKET);
    }
  ...
  ASSOCIATED_ZONE(SEPARATED)
  {
    Info
    {
      Pattern = "96[0-1](\t[^\t\n]*){13}";
      FieldSeparator = '\t';
      SuccState = SOL42_V430_REL_ZONE_PACKET;
    }
  ...
  ZONE_PACKET(SEPARATED)
  {
    Info
    {
      Pattern = "([^\t\n]*\t){4}[^\t\n]*";
      FieldSeparator = '\t';
      States = (SOL42_V430_REL_ZONE_PACKET);
    }
  ...
  ASSOCIATED_CHARGE(SEPARATED)
  {
    Info
    {
      ...
      FieldSeparator = '\t';
      SuccState = SOL42_V430_REL_CHARGE_PACKET;
    }
  ...
  { 
    Info
    {
      Pattern = "([^\t\n]*\t){39}[^\t\n]*";
      FieldSeparator = '\t';
      States = (SOL42_V430_REL_CHARGE_PACKET);
    }
  ...
  EOL(FIX)
  {
    Info
    {
      Pattern = "\n";
      States = (SOL42_V430_REL_SS_EVENT_PACKET,
                SOL42_V430_REL_CHARGE_PACKET,
                SOL42_V430_REL_ZONE_PACKET,
                SOL42_V430_REL_BALANCE_PACKET);
      SuccState = INITIAL;
    }      
