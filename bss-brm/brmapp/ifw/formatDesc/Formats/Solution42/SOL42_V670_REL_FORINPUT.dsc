...
//
// $RCSfile: SOL42_V670_REL_FORINPUT.dsc $
// $Revision: /cgbubrm_7.5.0.pipeline/3 $
// $Author: vinodrao $
// $Date: 2014/11/30 21:55:54 $
// $Locker:  $
//------------------------------------------------------------------------------
// $Log: SOL42_V670_REL_FORINPUT.dsc,v $
//==============================================================================
...
SOL42_V670_REL_FORINPUT
{
  ...
  DETAIL(SEPARATED)
  {
    Info
    {
      Pattern = "(02[0-9]|03[0-1]|04[0-9]|050|060|070|08[0-2]|12[0-8]|13[0-1]|220|701).*\n";
      FieldSeparator = '\t';
      RecordSeparator = '\n';
    }
  ...
  ASSOCIATED_LTE(SEPARATED)
  {
    ...
    DEVICE_NUMBER                       AscString();
    LOCATION_AREA_INDICATOR             AscString();
    PCSCF_ADDRESS                       AscString();
    SERVING_GATEWAY_ADDRESS             AscString();	
    PDN_GATEWAY_ADDRESS                 AscString();
    CELL_ID                             AscString();
    EVENT_REFERENCE                     AscString();
    MESSAGING_EVENT_SERVICE             AscInteger();	
    MOBILE_SESSION_SERVICE              AscInteger();	
    PUBLIC_USER_ID                      AscString(); 
    NON_CHARGED_PUBLIC_USERID           AscString(); 
    NON_CHARGED_PARTY_NUMBER            AscString();
    REQUESTED_NUMBER                    AscString();
    REQUESTED_PUBLIC_USERID             AscString();
  }
  ...
  //----------------------------------------------------------------------------
  //  Infranet Monitor Sub Bal Impact packet
  //----------------------------------------------------------------------------
