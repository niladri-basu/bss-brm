...
//------------------------------------------------------------------------------
// Module Description:
//   Generic I/O input grammar file for the Solution42 V6.50 REL CDR format 
...
//
// $RCSfile: SOL42_V650_REL_FORINPUT_InGrammar.dsc,v $
// $Revision: 1.2 $
// $Author: pengelbr $
// $Date: 2001/09/27 11:58:42 $
// $Locker:  $
//------------------------------------------------------------------------------
// $Log: SOL42_V650_REL_FORINPUT_InGrammar.dsc,v $
//==============================================================================
