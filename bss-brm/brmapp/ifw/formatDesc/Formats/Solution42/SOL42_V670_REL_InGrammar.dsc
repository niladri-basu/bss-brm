...
Grammar
{
  ...
  tax_packet_list:
      tax_packet_list
      SOL42_V670_REL_FORINPUT.TAX_PACKET 
        {
          edrAddDatablock( DETAIL.ASS_CBD.TP );
          edrInputMap( "SOL42_V670_REL_FORINPUT.TAX_PACKET.STD_MAPPING" );
        }
    | /* EMPTY */
    ;
  ...
  //----------------------------------------------------------------------------
  associated_lte:
      SOL42_V670_REL_FORINPUT.ASSOCIATED_LTE 
        {
          edrAddDatablock( DETAIL.ASS_LTE_EXT );
          edrInputMap( "SOL42_V670_REL_FORINPUT.ASSOCIATED_LTE.STD_MAPPING" );
        }
    ;
