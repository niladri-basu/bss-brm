...
// $Author: arcmisra $
// $Date: 2014/03/13 23:03:35 $
// $Locker:  $
//------------------------------------------------------------------------------
// $Log: SOL42_V670_REL_InMap.dsc,v $
//==============================================================================

SOL42_V670_REL_FORINPUT
{
  //----------------------------------------------------------------------------
  // Header record
  //----------------------------------------------------------------------------
  ...
  ASSOCIATED_LTE
  {
    STD_MAPPING
    {
      ...
      REQUESTED_NUMBER                  -> DETAIL.ASS_LTE_EXT.REQUESTED_NUMBER;
      REQUESTED_PUBLIC_USERID           -> DETAIL.ASS_LTE_EXT.REQUESTED_PUBLIC_USERID;
    }
  }
