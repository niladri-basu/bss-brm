...
//
// $RCSfile: SOL42_V411_InGrammar.dsc,v $
// $Revision: 1.5 $
// $Author: pengelbr $
// $Date: 2001/07/18 10:04:32 $
// $Locker:  $
//------------------------------------------------------------------------------
// $Log: SOL42_V411_InGrammar.dsc,v $
...
Grammar
{
       ...
       SOL42_V411.HEADER 
        {
          ...
          edrInputMap( "SOL42_V411.HEADER.STD_MAPPING" );
      ...
      SOL42_V411.TRAILER 
        {
          ...
          edrInputMap( "SOL42_V411.TRAILER.STD_MAPPING" );
      ...
      SOL42_V411.DETAIL  
        {
          ...
          edrInputMap( "SOL42_V411.DETAIL.STD_MAPPING" );
  ...
  charge:
      SOL42_V411.ASSOCIATED_CHARGE 
      {
        ...
        edrInputMap( "SOL42_V411.ASSOCIATED_CHARGE.STD_MAPPING" );
      }
      packets
      SOL42_V411.EOL
    | /* EMPTY */
  ...
  packets:
      ...
      SOL42_V411.CHARGE_PACKET 
      {
        ...
        edrInputMap( "SOL42_V411.CHARGE_PACKET.STD_MAPPING" );
      }
    | /* EMPTY */
    ;
}
