...
//------------------------------------------------------------------------------
// Module Description:
//   Output mapping for the Solution42 V6.70 CDR format with Unix timestamps
//
// Open Points:
//   <open points>
//
...
//
// $RCSfile: SOL42_V670_OutMap.dsc $
// $Revision: /cgbubrm_7.3.2.pipeline/3 $
// $Author: shthomas $
// $Date: 2010/07/13 04:34:18 $
// $Locker:  $
//------------------------------------------------------------------------------
// $Log: SOL42_V670_OutMap.dsc,v $
//==============================================================================
...
{     
  ...
  BALANCE_PACKET
  {
    STD_MAPPING
    {
      ...
      OBJECT_CACHE_TYPE           <- DETAIL.ASS_PIN.BP.OBJECT_CACHE_TYPE;
      ...
      PIN_QUANTITY                <- DETAIL.ASS_PIN.BP.PIN_QUANTITY;
      PIN_AMOUNT                  <- DETAIL.ASS_PIN.BP.PIN_AMOUNT;
      PIN_AMOUNT_DEFERRED         <- DETAIL.ASS_PIN.BP.PIN_AMOUNT;
