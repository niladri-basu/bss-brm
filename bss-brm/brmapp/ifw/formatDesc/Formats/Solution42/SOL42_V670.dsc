...
//------------------------------------------------------------------------------
// Module Description:
//   Description of the Solution42 V6.70 CDR format 
//
// Open Points:
//   <open points>
//
...
SOL42_V670
{
  ...
  DETAIL(SEPARATED)
  {
    Info
    {
      Pattern = "(02[0-8]|03[0-1]|04[0-9]|050|060|070|12[0-8]|13[0-1]|220|701).*\n";
      FieldSeparator = '\t';
      RecordSeparator = '\n';
    }
    ...
    UTC_END_TIME_OFFSET                 AscString();
    NE_CHARGING_START_TIMESTAMP         AscDate();
    UTC_NE_START_TIME_OFFSET            AscString();
    NE_CHARGING_END_TIMESTAMP           AscDate();
