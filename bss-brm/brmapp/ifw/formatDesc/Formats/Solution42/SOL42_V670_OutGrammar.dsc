...
//
// $RCSfile: SOL42_V670_OutGrammar.dsc $
// $Revision: /cgbubrm_7.3.2.pipeline/1 $
// $Author: knijhawa $
// $Date: 2009/02/08 21:45:20 $
// $Locker:  $
//------------------------------------------------------------------------------
      ...
      DETAIL
        {
          ...
          if ( edrNumDatablocks( DETAIL.ASS_CIBER_EXT ) > 0 )
          {
            ...
            edrOutputMap( "SOL42_V670.ASSOCIATED_CIBER.STD_MAPPING", 0 );
          }
          ...
          if ( edrNumDatablocks( DETAIL.ASS_ROAMING_EXT ) > 0 )
          {
            ...
            edrOutputMap( "SOL42_V670.ASSOCIATED_ROAMING.STD_MAPPING", 0 );
          }
