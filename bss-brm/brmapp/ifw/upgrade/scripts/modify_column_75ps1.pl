...
# 
#@(#)$Id: modify_column_75ps1.pl /cgbubrm_7.5.0.rwsmod/1 2012/03/12 09:37:23 hsnagpal Exp $
#
# modify_columns_75ps1.pl
# 
# Copyright (c) 2010, 2012, Oracle and/or its affiliates. All rights reserved. 
#
#    NAME
#      modify_columns_75ps1.pl - This module will result in creating missing indexes . 
#
#    DESCRIPTION
...
#	modify_columns_75ps1.pl for execution.
#
#    NOTES
#	The Driver File for upgrade which is the script "pin_74_75ps1_pipeline_upgrade.pl"
#	will call this perl script (modify_columns_75ps1.pl)  through one of its wrappers APIs
#	named modify_columns_75ps1() .

#    ERROR HANDLING
#	The Error Handling will be done by logging the error messages in the log file.
#	This log file is modify_columns_75ps1.log which will be generated in $IFW_HOME/log directory.
...
require "$UPG_DIR/pipeline_tables.cfg";
...
our @ALL_INDEX_SCRIPTS_75PS1 = ("pin_upg_common.source","duplicatecheck_update.source","discountOfferWithTaxCode_transformation.source");

sub modify_columns_75ps1 {
        my $file = "";
        my $time_stamp = "";
        my $addnewindfile = "$IFW_LOG_DIR/modify_columns_75ps1.log";
        my $ReadString = "";
        my $Result    = 0;
        my $FirstElem = $ALL_INDEX_SCRIPTS_75PS1[0];
        my $writestatement = "";
	my $opt_mgr_tablename = "";
        ...
        if ( $FirstElem eq "" ) {
                ...
                $SETUP_LOG_FILENAME = "$IFW_LOG_DIR/tmp_modify_columns_75ps1.log";
                $SETUP_LOG_ACCESS_TYPE = "WRITE";
                &OpenLogFile( $SETUP_LOG_FILENAME, $SETUP_LOG_ACCESS_TYPE );
        
	        foreach $file (@ALL_INDEX_SCRIPTS_75PS1) {
