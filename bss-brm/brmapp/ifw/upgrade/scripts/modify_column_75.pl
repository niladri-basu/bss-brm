...
# 
#@(#)$Id: modify_column_75.pl /cgbubrm_main.rwsmod/2 2011/09/07 05:59:08 hsnagpal Exp $
#
# modify_columns_75.pl
# 
# Copyright (c) 2010, 2011, Oracle and/or its affiliates. All rights reserved. 
#
#    NAME
#      modify_columns_75.pl - This module will result in creating missing indexes . 
#
#    DESCRIPTION
...
#	modify_columns_75.pl for execution.
#
#    NOTES
#	The Driver File for upgrade which is the script "pin_74_75_pipeline_upgrade.pl"
#	will call this perl script (modify_columns_75.pl)  through one of its wrappers APIs
#	named modify_columns_75() .

#    ERROR HANDLING
#	The Error Handling will be done by logging the error messages in the log file.
#	This log file is modify_columns_75.log which will be generated in $IFW_HOME/log directory.
...
our @ALL_INDEX_SCRIPTS_75 = ("pipeline_schema_update.source");

sub modify_columns_75 {
        my $file = "";
        my $time_stamp = "";
        my $addnewindfile = "$IFW_LOG_DIR/modify_columns_75.log";
        my $ReadString = "";
        my $Result    = 0;
        my $FirstElem = $ALL_INDEX_SCRIPTS_75[0];
        my $writestatement = "";
	my $opt_mgr_tablename = "";
        ...
        if ( $FirstElem eq "" ) {
                ...
                $SETUP_LOG_FILENAME = "$IFW_LOG_DIR/tmp_modify_columns_75.log";
                $SETUP_LOG_ACCESS_TYPE = "WRITE";
                &OpenLogFile( $SETUP_LOG_FILENAME, $SETUP_LOG_ACCESS_TYPE );
        
	        foreach $file (@ALL_INDEX_SCRIPTS_75) {
